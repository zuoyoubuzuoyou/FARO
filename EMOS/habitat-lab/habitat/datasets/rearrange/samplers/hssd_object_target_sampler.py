...
from habitat.datasets.rearrange.samplers.hssd_object_sampler import HssdObjectSampler
...
class HssdObjectTargetSampler(HssdObjectSampler):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize a standard HssdObjectSampler but construct the object_set to correspond with specific object instances provided.
        """

...
from rlm_utils.gpt_fast.model import Attention, FeedForward, Transformer
from rlm_utils.gpt_fast.quantize import WeightOnlyInt4Linear
...
def maybe_init_dist() -> Optional[int]:
    ...
    # Set timeout very high to avoid watchdog from long startup
